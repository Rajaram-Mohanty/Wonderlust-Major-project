...
module.exports.login = async(req,res)=>{          //local is one of the way we used to implement authentication similar to sign up with linked in. failureFlash handles the error and flashes the message so no try catch required here.
